...
- Correction (bibliography): Russo (2012) had been listed as a chapter in Montanari (ed.), Homeric Contexts, which contains no Russo chapter. The article is Joseph A. Russo, "Re-thinking Homeric Psychology: Snell, Dodds, and their Critics", Quaderni Urbinati di Cultura Classica n.s. 101(2), 11-28 (2012), confirmed through OpenAlex (W2292590358), JSTOR 23347416 and the Haverford College repository record. The original sentence and its quotation are kept; the quotation could not be checked against the full text and is not bound in claims.yaml.
